...
public class RegistrationList extends JFrame implements ActionListener
{
    ...
    JButton print,cancel;
     ...
     RegistrationList()
    {
        JLabel heading = new JLabel("REGISTRATION LIST");
        ...
        try {
            ...
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from registration");
    ...
    RegistrationList(String username) {
