...
public class Discharge extends JFrame implements ActionListener {
   ...
   JComboBox cid;
   JTextField tc,idno,tad,te,tp,lname,uid;
   JRadioButton GM,GF;
   JButton bak,add;
    ...
    Discharge(String username)
    {
        ...
        JLabel text = new JLabel("DISCHARGE PATIENT");
    ...
    public void actionPerformed(ActionEvent ae)
    {
       ...
       {   String card =(String) cid.getSelectedItem();
           ...
           boolean isValidIdNumber = false;
            ...
            {
                Conn co = new Conn();
                String query = "insert into discharge values('"+patient+"','"+card+"','"+number+"','"+name+"','"+gender+"','"+country+"','"+address+"','"+phone+"','"+email+"')";
                co.s.executeUpdate(query);
                
                JOptionPane.showMessageDialog(null, "Details Stored Succesfully");
                setVisible(false);
            }
            catch(Exception E){}
        }}}
